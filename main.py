...
with open("D:/Kawa/Kuliah/Valorant/data/coco-dataset.labels", "r") as f:
    class_names = [cname.strip() for cname in f.readlines()]
 
 
net = cv2.dnn.readNet("D:/Kawa/Kuliah/Valorant/data/yolov4-tiny.weights", "D:/Kawa/Kuliah/Valorant/data/yolov4-tiny.cfg")
...
while True:
    ...
    if enemyNum == 0:
        ...
        if abs(difX) < 2 and abs(difY) < 2:
            ...
            if mouse.is_pressed() or keyboard.is_pressed("ctrl"):
